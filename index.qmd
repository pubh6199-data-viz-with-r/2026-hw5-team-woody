...
pal <- colorNumeric("RdYlBu", domain = midwest_sf$percbelowpoverty) #using the sf object with midwest_sf

addLegend(pal = pal, values = ~ percbelowpoverty, title = "Percent Below Poverty") |>  #added legend
